        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="text-center space-y-4">
            ...
            <p className="text-xs md:text-sm font-medium">
              Entre em contato com o suporte para ativar sua conta ou volte para a tela de login.
            </p>
            <div className="flex flex-col md:flex-row items-center justify-center gap-3">
              ...
              <Button asChild variant="outline" className="px-4 md:px-6 py-2.5 md:py-3 text-sm md:text-base">
                <Link to="/auth" aria-label="Voltar para a tela de login">Voltar para Login</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
