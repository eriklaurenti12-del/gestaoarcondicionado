    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-cyan-950 text-white overflow-x-hidden">
      ...
      {settings.landing_whatsapp_flutuante !== 'false' && settings.landing_whatsapp_link && (
        <a
          ...
          className="fixed bottom-6 right-6 z-50 w-16 h-16 rounded-full bg-[#25D366] hover:bg-[#128C7E] flex items-center justify-center shadow-2xl shadow-green-500/50 transition-all duration-300 hover:scale-110 group animate-bounce"
